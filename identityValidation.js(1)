...
define(["react", "react-redux", "../../../lib/utils", "../../../common/inputvalidation", "../../../common/loader", "../../../controller/beneficiariosController", "../../../common/errormessage", "../../../common/modalReactBootstrap"], function (React, ReactRedux, Utils, InputValidation, Loader, BeneficiariosController, Errormessage, ModalReactBootstrap) {
    var IdentityValidationBeneficiary = function (_React$Component) {
        ...
        _createClass(IdentityValidationBeneficiary, [{
            ...
            value: function componentDidMount() {
                ...
                // this.controller.sendValidationEmail(data => {
                //     if (data == true) {
                //         this.setState({
                //             loaded: true
                //         })
