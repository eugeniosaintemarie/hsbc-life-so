...
define(["react"], function (React) {
  var InputValidationExt = function (_React$PureComponent) {
    _inherits(InputValidationExt, _React$PureComponent);

    function InputValidationExt(props) {
      _classCallCheck(this, InputValidationExt);

      var _this = _possibleConstructorReturn(this, (InputValidationExt.__proto__ || Object.getPrototypeOf(InputValidationExt)).call(this, props));
    ...
    _createClass(InputValidationExt, [{
      key: "_validation",
      value: function _validation() {
        if (this.used === true) {
          ...
          if (!this.value) {
            ...
            validation = invalid;
          } else if (this.value > campoCompare) {
