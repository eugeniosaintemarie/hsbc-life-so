...
define(["react", "../../libs/react/js/react-input-mask.min"], function (React, InputMask) {
  var InputValidationAcOff = function (_React$PureComponent) {
    _inherits(InputValidationAcOff, _React$PureComponent);

    function InputValidationAcOff(props) {
      _classCallCheck(this, InputValidationAcOff);

      var _this = _possibleConstructorReturn(this, (InputValidationAcOff.__proto__ || Object.getPrototypeOf(InputValidationAcOff)).call(this, props));
    ...
    _createClass(InputValidationAcOff, [{
      key: "_validation",
      value: function _validation(flag) {
        if (this.used === true) {
          ...
          var characters = React.createElement(
            ...
            "La longitud m\xC3\xADnima es de " + this.props.minLength + " caracteres."
          );
          var invalid = null;
          var regExp = null;
          ...
          //s̩ modifico para mostrar un error a la vez en pantalla
          if (!this.value) {
            validation = [required];
      ...
      value: function render() {
        ...
        //s̩ modifico para agregar input-invalid css class y autoFocus cuando se requiera con el automcplete off
