//tealium universal tag - utag.305 ut4.0.202402010709, Copyright 2024 Tealium.com Inc. All Rights Reserved.
...
if(!TMS.util.check.isDefined(window.impressiontrackingrunning)){window.impressiontrackingrunning=true;window.Evnt.addE(document,"click",function(e){promoclicktracking(e);});promo.init();}}}};utag.o[loader].loader.LOAD(id);})("305","hsbc.ar-rbwm");}catch(error){utag.DB(error);}