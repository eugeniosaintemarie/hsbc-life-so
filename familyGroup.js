...
define(["react", "./grupoFamiliar/listNewFamilyGroup", "./grupoFamiliar/newFamilyGroup", "../../../controller/endososController", "../../retiroNomina/beneficiary/identityValidation", "../../../controller/beneficiariosController", "../processOKVC"], function (React, ListNewFamilyGroup, NewFamilyGroup, EndososController, IdentityValidation, BeneficiariosController, ProcessOK) {
  var FamilyGroup = function (_React$Component) {
    _inherits(FamilyGroup, _React$Component);

    function FamilyGroup(props) {
      _classCallCheck(this, FamilyGroup);

      var _this = _possibleConstructorReturn(this, (FamilyGroup.__proto__ || Object.getPrototypeOf(FamilyGroup)).call(this, props));
      ...
      _this._getParentName = function (code) {
        ...
        _this.props.listParentesco.map(function (e) {
          if (parseInt(e.GRUPOCOD) == code) {
            parentName = e.GRUPODES;
          }
        });
        return parentName;
      };
      ...
      value: function render() {
        ...
        switch (currentForm) {
          case "ListBeneficiaries":
            return React.createElement(ListNewFamilyGroup, {
              ...
              listParentesco: this.props.listParentesco,
