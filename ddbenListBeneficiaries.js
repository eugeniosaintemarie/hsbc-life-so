      ...
      _this._checkUpdate = function () {
        ...
        sorterOrders.map(function (order) {
          ...
          _this.props.listaBeneficiarios.map(function (benef) {
            if (benef.NOMINAS.ORDEN == order) {
              totalporcentaje += benef.NOMINAS.PORCENT;
            }
          });
          if (totalporcentaje < 10000) {
            validationOK = false;
            textError = "La orden " + order + " no llega a cubrir el 100%";
          } else if (totalporcentaje > 10000) {
            validationOK = false;
        ...
        if (_this.props.listaBeneficiarios.length == 0) {
          _this.setState({ showError: true, textError: "No se ingreso ningún beneficiario" });
        } else if (validationOK) {
          _this.props.handlerSwitch("identyValidationIndividualBeneficiary");
        }
      };
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement("i", { "class": "far fa-comment-dots fa-flip-horizontal fa-3x float-left mr-3" }),
                "Si quer\xE9s designar como beneficiario una persona jur\xEDdica, pod\xE9s hacerlo llamando al 0800-333-0003"
              )
            )
          )
        );
