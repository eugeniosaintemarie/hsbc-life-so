...
define(["react", "../../../common/inputvalidation", "../../../common/inputValidationAcOff", "../../../common/dropdownContent", "../../../common/datepicker", "../../../common/datepickerAcOff", "../../../common/modalReactBootstrap", "../../../controller/vidaColectivoController"], function (React, InputValidation, InputValidationAcOff, DropDownContent, DatePicker, DatePickerAcOff, ModalReactBootstrap, VidaColectivoController) {
  var FormPointApConyuge = function (_React$Component) {
    _inherits(FormPointApConyuge, _React$Component);

    function FormPointApConyuge(props) {
      _classCallCheck(this, FormPointApConyuge);

      var _this = _possibleConstructorReturn(this, (FormPointApConyuge.__proto__ || Object.getPrototypeOf(FormPointApConyuge)).call(this, props));
      ...
      _this._handleResults = function (id, result) {
        ...
        if (id == "formConyuge") {
          if (result.id == 2) {
            _this.state.noCheck = false; /**permite cambiar los datos si antes estaban guardados */
          } else {
      ...
      var _ref = _this.props.formInfo ? _this.props.formInfo : "",
          ...
          _ref$applicantNationa = _ref.applicantNationalityConyuge,
          applicantNationalityConyuge = _ref$applicantNationa === undefined ? "" : _ref$applicantNationa,
          _ref$applicantGenderC = _ref.applicantGenderConyuge,
          applicantGenderConyuge = _ref$applicantGenderC === undefined ? "" : _ref$applicantGenderC;

      _this.state = {
        formConyuge: { id: formConyuge },
        applicantCUILConyuge: { value: applicantCUILConyuge, isValidate: false, required: true },
        applicantNameConyuge: { value: applicantNameConyuge, isValidate: false, required: true },
        applicantSurnameConyuge: { value: applicantSurnameConyuge, isValidate: false, required: true },
        applicantDateBirthConyuge: { value: applicantDateBirthConyuge, isValidate: false, required: true },
        applicantEmailConyuge: { value: applicantEmailConyuge, isValidate: false, required: true },
        applicantNationalityConyuge: { id: applicantNationalityConyuge, value: "", isValidate: false, required: true },
        applicantGenderConyuge: { id: applicantGenderConyuge, value: "", isValidate: false, required: true },
        showModal: false,
        invalidDate: false,
        loading: false,
        checkEmail: false,
      ...
      _this.referencies = {
        ...
        applicantNationalityConyuge: React.createRef(),
        applicantGenderConyuge: React.createRef()
      };
      return _this;
    }

    _createClass(FormPointApConyuge, [{
      key: "render",
      value: function render() {
        ...
        var fechaActual = this.props.fechaAct.split(" ");
          ...
          this.state.formConyuge.id == "1" && this.props.check || this.state.noCheck ? React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    {
                      className: "font-size-ddben-beneficiary",
                      htmlFor: "applicantGenderConyuge"
                    },
                    "Sexo"
                  ),
                  React.createElement(DropDownContent, {
                    ref: this.referencies.applicantGenderConyuge,
                    list: this.props.sexoList,
                    className: "input-background-color form-control input-size",
                    id: "applicantGenderConyuge",
                    name: "applicantGenderConyuge",
                    typeValue: "id",
                    defaultValue: this.state.applicantGenderConyuge.id,
                    onResult: this._handleResults,
                    disabled: readOnly,
                    required: true
                  })
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    {
                      className: "font-size-ddben-beneficiary",
                      htmlFor: "applicantNationalityConyuge"
                    },
                    "Nacionalidad"
                  ),
                  React.createElement(DropDownContent, {
                    ref: this.referencies.applicantNationalityConyuge,
                    list: this.props.countriesList,
                    className: "input-background-color form-control input-size",
                    id: "applicantNationalityConyuge",
                    name: "applicantNationalityConyuge",
                    idObject: "CODIGO",
                    nameObject: "DESCRIPCION",
                    typeValue: "id",
                    defaultValue: this.state.applicantNationalityConyuge.id,
                    onResult: this._handleResults,
                    disabled: readOnly,
                    required: true
                  })
              ...
              this.state.validationConyuge ? React.createElement(
                "p",
                { className: " col-5 text-center alert-danger" },
                React.createElement(
                  "b",
                  null,
