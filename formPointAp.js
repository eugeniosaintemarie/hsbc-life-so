...
define(["react", "../../../common/inputvalidation", "../../../common/numTelefono", "../../../common/dropdownContent", "../../../controller/endososController", "../../../controller/retiroNominaController", "../../../common/datepicker", "../../../common/search", "../../../common/modalReactBootstrap"], function (React, InputValidation, NumTelefono, DropDownContent, EndososController, RetiroNominaController, DatePicker, Search, ModalReactBootstrap) {
  var FormPointAp = function (_React$Component) {
    _inherits(FormPointAp, _React$Component);

    function FormPointAp(props) {
      _classCallCheck(this, FormPointAp);

      var _this = _possibleConstructorReturn(this, (FormPointAp.__proto__ || Object.getPrototypeOf(FormPointAp)).call(this, props));
      ...
      value: function render() {
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "div",
              { className: "text-danger font-size float-right form-group col-4 small" },
              React.createElement(
                "p",
                null,
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(DropDownContent, {
                ...
                list: this.props.provincesList ? this.props.provincesList : [],
                className: "input-background-color form-control input-size",
                ...
                nameObject: "DES_PRV",
                typeValue: "id",
                defaultValue: this.state.applicantProvince.value,
