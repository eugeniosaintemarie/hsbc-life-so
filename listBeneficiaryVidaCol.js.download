...
define(["react", "../../retiroNomina/beneficiary/ddbenTable", "../../../common/modalReactBootstrap", "../../../common/errormessage"], function (React, DdbenTable, ModalReactBootstrap, ErrorMessage) {
  var ListBeneficiaryVidaCol = function (_React$Component) {
    _inherits(ListBeneficiaryVidaCol, _React$Component);

    function ListBeneficiaryVidaCol(props) {
      _classCallCheck(this, ListBeneficiaryVidaCol);

      var _this = _possibleConstructorReturn(this, (ListBeneficiaryVidaCol.__proto__ || Object.getPrototypeOf(ListBeneficiaryVidaCol)).call(this, props));
      ...
      _this._checkUpdate = function () {
        ...
        for (var i = 0; i < names.length; i++) {
          ...
          if (!resultName) {
            validationOK = false;
            textError = "Algún beneficiario no tiene el nombre con el formato correcto, por favor ingresá a los mismos y verificalos. Muchas gracias.";
          }
          if (!resultLastName) {
            validationOK = false;
            textError = "Algún beneficiario no tiene el apellido con el formato correcto, por favor ingresá a los mismos y verificalos. Muchas gracias.";
          }
          ...
          var resultRelationship = relationship[i];
          if (resultRelationship == "" || resultRelationship == "AC" || resultRelationship == "EM" || resultRelationship == "OT") {
            validationOK = false;
            textError = "Algún beneficiario no tiene el parentesco con el formato correcto, por favor ingresá a los mismos y verificalos. Muchas gracias.";
          }
          ...
          if (!resultDocNumber || resultDocType == 0) {
            validationOK = false;
            textError = "Algún beneficiario no tiene el número de documento con el formato correcto, por favor ingresá a los mismos y verificalos. Muchas gracias.";
          }
          if (resultDocType == 0) {
            validationOK = false;
            textError = "Algún beneficiario no tiene el tipo de documento con el formato correcto, por favor ingresá a los mismos y verificalos. Muchas gracias.";
          }
        }
        ...
        if (ordersOrdered[0] != undefined && ordersOrdered[0] != "1") {
          validationOK = false;
          textError = "Número de orden incorrecto, no puede haber orden " + ordersOrdered[0] + " sin tener orden 1, por favor ingresá a los mismos y verificalo. Muchas gracias.";
        }
        if (consecutive != 0 && ordersOrdered.length > 1) {
          validationOK = false;
          textError = "Los números de orden no son consecutivos, por favor ingresá a los mismos y verificalos. Muchas gracias.";
        }
        ...
        sorterOrders.map(function (order) {
          ...
          if (totalporcentaje < 100) {
            validationOK = false;
            textError = "El orden " + order + " no llega a cubrir el 100%";
          } else if (totalporcentaje > 100) {
            validationOK = false;
            textError = "El orden " + order + " supera el 100%";
          }
        });
      ...
      _this._handleAccept = function (e) {
        ...
        _this.props.onResults(unchecked, true);
      };
    ...
    _createClass(ListBeneficiaryVidaCol, [{
      key: "render",
      value: function render() {
        return React.createElement(
          ...
          React.createElement(
            ...
            "DESIGNAR SUS BENEFICIARIOS EN LA COBERTURA QUE EST\xC1 CONTRATANDO ES UN DERECHO QUE USTED POSEE. LA NO DESIGNACI\xD3N DE BENEFICIARIOS, O SU DESIGNACI\xD3N ERR\xD3NEA PUEDE IMPLICAR DEMORAS EN EL TR\xC1MITE DE COBRO DEL BENEFICIO. ASIMISMO, USTED TIENE DERECHO A EFECTUAR O A MODIFICAR SU DESIGNACI\xD3N EN CUALQUIER MOMENTO, POR ESCRITO SIN NINGUNA OTRA FORMALIDAD."
          ),
          ...
          this.props.readOnly ? "" : React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                "Si tu conyuge/conviviente desea designar beneficiarios deber\xE1 escribir un correo electr\xF3nico a contactenos@hsbc.com.ar"
              )
            )
          ),
          React.createElement(
